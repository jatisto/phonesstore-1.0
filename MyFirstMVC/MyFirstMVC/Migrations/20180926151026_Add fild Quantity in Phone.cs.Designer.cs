...
namespace MyFirstMVC.Migrations
{
    ...
    [Migration("20180926151026_Add fild Quantity in Phone.cs")]
    partial class AddfildQuantityinPhonecs
    {
            ...
            modelBuilder.Entity("MyFirstMVC.Models.Phone", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CategoryId = 1, CompanyId = 1, Name = "Apple iPhone 7 256Gb Red", Price = 74400.0, Quantity = 0 },
                        new { Id = 2, CategoryId = 1, CompanyId = 1, Name = "Apple iPhone 6S (Space Grey, 32GB)", Price = 30500.0, Quantity = 0 },
                        new { Id = 3, CategoryId = 1, CompanyId = 1, Name = "Apple iPhone X (Space Grey, 256GB)", Price = 99999.0, Quantity = 0 },
                        ...
                        new { Id = 6, CategoryId = 2, CompanyId = 4, Name = "Redmi 6 Pro (Black, 32GB)", Price = 11499.0, Quantity = 0 },
                        new { Id = 7, CategoryId = 2, CompanyId = 4, Name = "Redmi Y2 (Rose Gold, 32GB)", Price = 9999.0, Quantity = 0 },
                        new { Id = 8, CategoryId = 2, CompanyId = 5, Name = "LG Q6 (Black, 18:9 FullVision Display)", Price = 11820.0, Quantity = 0 },
                        new { Id = 9, CategoryId = 2, CompanyId = 5, Name = "LG V30+ (18:9 OLED FullVisionTM, 128GB, Black)", Price = 34963.0, Quantity = 0 },
                        new { Id = 10, CategoryId = 3, CompanyId = 8, Name = "BlackBerry Passport 32GB (White)", Price = 26999.0, Quantity = 0 },
                        new { Id = 11, CategoryId = 2, CompanyId = 6, Name = "Huawei P20 Pro Blue (40MP Leica Triple Camera, 6GB+128GB)", Price = 64999.0, Quantity = 0 },
                        new { Id = 12, CategoryId = 2, CompanyId = 3, Name = "Nokia 6.1 (2018) (4GB + 64GB, Blue-Gold)", Price = 15950.0, Quantity = 0 },
